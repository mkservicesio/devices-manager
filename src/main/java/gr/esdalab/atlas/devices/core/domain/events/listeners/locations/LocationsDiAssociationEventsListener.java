...
public class LocationsDiAssociationEventsListener implements ApplicationListener<AssociationEvent.LocationDiAssociationEvent<?>> {
     ...
     */
    @Override
    public void onApplicationEvent(final AssociationEvent.LocationDiAssociationEvent<?> event) {
    ...
    private void handle(final int locationId,
        ...
        associationsUseCase.removeLocationAssociationWith(locationId, association);
    }
}
